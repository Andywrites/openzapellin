...
View Source: [contracts/mocks/RefundableCrowdsaleImpl.sol](../contracts/mocks/RefundableCrowdsaleImpl.sol)

**↗ Extends: [RefundableCrowdsale](RefundableCrowdsale.md)**
...
```js
constructor(uint256 rate, address wallet, ERC20Mintable token) public
```
