...
View Source: [contracts/utils/Arrays.sol](../contracts/utils/Arrays.sol)
...
Upper bound search function which is kind of binary search algoritm. It searches sorted
...
```js
function findUpperBound(uint256[] array, uint256 element) internal
returns(uint256)
```

**Returns**

The calculated index value. Returns 0 for empty array.

**Arguments**

| Name        | Type           | Description  |
| ------------- |------------- | -----|
| array | uint256[] | The array sorted in ascending order. | 
| element | uint256 | The element's value to be find. | 
