...
View Source: [contracts/crowdsale/price/IncreasingPriceCrowdsale.sol](../contracts/crowdsale/price/IncreasingPriceCrowdsale.sol)
...
```js
function getCurrentRate() public
returns(uint256)
```
