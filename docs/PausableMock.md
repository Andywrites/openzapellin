...
View Source: [contracts/mocks/PausableMock.sol](../contracts/mocks/PausableMock.sol)

**↗ Extends: [Pausable](Pausable.md), [PauserRoleMock](PauserRoleMock.md)**
...
- [drasticMeasure()](#drasticmeasure)

### normalProcess

```js
function normalProcess() external undefined whenNotPaused 
```
...
```js
function drasticMeasure() external undefined whenPaused 
```
