...
```js
function mint(address account, uint256 amount) public undefined
```
...
```js
function burn(address account, uint256 amount) public undefined
```
...
```js
function burnFrom(address account, uint256 amount) public undefined
```
