# PostDeliveryCrowdsale (PostDeliveryCrowdsale.sol)

View Source: [contracts/crowdsale/distribution/PostDeliveryCrowdsale.sol](../contracts/crowdsale/distribution/PostDeliveryCrowdsale.sol)

**↗ Extends: [TimedCrowdsale](TimedCrowdsale.md)**
**↘ Derived Contracts: [PostDeliveryCrowdsaleImpl](PostDeliveryCrowdsaleImpl.md)**
...
- [withdrawTokens(address beneficiary)](#withdrawtokens)
...
```js
function withdrawTokens(address beneficiary) public undefined
```
...
| ------------- |------------- | -----|
| beneficiary | address | Whose tokens will be withdrawn. | 
