...
View Source: [contracts/mocks/CapperRoleMock.sol](../contracts/mocks/CapperRoleMock.sol)

**↗ Extends: [CapperRole](CapperRole.md)**
...
- [removeCapper(address account)](#removecapper)
- [onlyCapperMock()](#onlycappermock)
- [_removeCapper(address account)](#_removecapper)

### removeCapper

```js
function removeCapper(address account) public undefined
```
...
```js
function onlyCapperMock() public onlyCapper 
```
...
⤾ overrides [CapperRole._removeCapper](CapperRole.md#_removecapper)
