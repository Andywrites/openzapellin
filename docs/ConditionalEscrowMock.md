...
View Source: [contracts/mocks/ConditionalEscrowMock.sol](../contracts/mocks/ConditionalEscrowMock.sol)

**↗ Extends: [ConditionalEscrow](ConditionalEscrow.md)**
...
- [setAllowed(address payee, bool allowed)](#setallowed)
- [withdrawalAllowed(address payee)](#withdrawalallowed)

### setAllowed

```js
function setAllowed(address payee, bool allowed) public undefined
```
...
⤾ overrides [ConditionalEscrow.withdrawalAllowed](ConditionalEscrow.md#withdrawalallowed)
