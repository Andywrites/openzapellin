...
View Source: [contracts/token/ERC20/ERC20Mintable.sol](../contracts/token/ERC20/ERC20Mintable.sol)

**↗ Extends: [ERC20](ERC20.md), [MinterRole](MinterRole.md)**
**↘ Derived Contracts: [ERC20Capped](ERC20Capped.md), [ERC20MintableMock](ERC20MintableMock.md), [SampleCrowdsale](SampleCrowdsale.md), [SampleCrowdsaleToken](SampleCrowdsaleToken.md)**
...
- [mint(address to, uint256 value)](#mint)
