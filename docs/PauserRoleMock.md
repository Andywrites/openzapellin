...
View Source: [contracts/mocks/PauserRoleMock.sol](../contracts/mocks/PauserRoleMock.sol)

**↗ Extends: [PauserRole](PauserRole.md)**
**↘ Derived Contracts: [ERC20PausableMock](ERC20PausableMock.md), [ERC721PausableMock](ERC721PausableMock.md), [PausableMock](PausableMock.md)**

**PauserRoleMock**

## Functions

- [removePauser(address account)](#removepauser)
- [onlyPauserMock()](#onlypausermock)
- [_removePauser(address account)](#_removepauser)

### removePauser

```js
function removePauser(address account) public undefined
```
...
```js
function onlyPauserMock() public onlyPauser 
```
...
⤾ overrides [PauserRole._removePauser](PauserRole.md#_removepauser)
