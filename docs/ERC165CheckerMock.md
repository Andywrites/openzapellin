...
View Source: [contracts/mocks/ERC165CheckerMock.sol](../contracts/mocks/ERC165CheckerMock.sol)

**ERC165CheckerMock**

## Functions

- [supportsERC165(address account)](#supportserc165)
- [supportsInterface(address account, bytes4 interfaceId)](#supportsinterface)
- [supportsAllInterfaces(address account, bytes4[] interfaceIds)](#supportsallinterfaces)

### supportsERC165

```js
function supportsERC165(address account) public
returns(bool)
```
...
```js
function supportsInterface(address account, bytes4 interfaceId) public
returns(bool)
```
...
```js
function supportsAllInterfaces(address account, bytes4[] interfaceIds) public
returns(bool)
```
