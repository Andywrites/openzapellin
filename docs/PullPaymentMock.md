...
View Source: [contracts/mocks/PullPaymentMock.sol](../contracts/mocks/PullPaymentMock.sol)

**↗ Extends: [PullPayment](PullPayment.md)**

**PullPaymentMock**

## Functions

- [callTransfer(address dest, uint256 amount)](#calltransfer)

### callTransfer

```js
function callTransfer(address dest, uint256 amount) public undefined
```
