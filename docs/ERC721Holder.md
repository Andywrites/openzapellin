...
View Source: [contracts/token/ERC721/ERC721Holder.sol](../contracts/token/ERC721/ERC721Holder.sol)
...
```js
function onERC721Received(address , address , uint256 , bytes ) public undefined
returns(bytes4)
```
