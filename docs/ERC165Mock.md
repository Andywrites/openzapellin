...
View Source: [contracts/mocks/ERC165Mock.sol](../contracts/mocks/ERC165Mock.sol)

**↗ Extends: [ERC165](ERC165.md)**

**ERC165Mock**

## Functions

- [registerInterface(bytes4 interfaceId)](#registerinterface)

### registerInterface

```js
function registerInterface(bytes4 interfaceId) public undefined
```
