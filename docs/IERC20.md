...
View Source: [contracts/token/ERC20/IERC20.sol](../contracts/token/ERC20/IERC20.sol)

**↘ Derived Contracts: [ERC20](ERC20.md), [ERC20Detailed](ERC20Detailed.md), [ERC20TokenMetadata](ERC20TokenMetadata.md), [ERC20WithMetadata](ERC20WithMetadata.md)**
...
```js
function transfer(address to, uint256 value) external undefined
returns(bool)
```
...
```js
function approve(address spender, uint256 value) external undefined
returns(bool)
```
...
```js
function transferFrom(address from, address to, uint256 value) external undefined
returns(bool)
```
