...
View Source: [contracts/mocks/ReentrancyAttack.sol](../contracts/mocks/ReentrancyAttack.sol)

**ReentrancyAttack**

## Functions

- [callSender(bytes4 data)](#callsender)

### callSender

```js
function callSender(bytes4 data) public undefined
```
