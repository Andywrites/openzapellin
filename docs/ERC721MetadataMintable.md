...
View Source: [contracts/token/ERC721/ERC721MetadataMintable.sol](../contracts/token/ERC721/ERC721MetadataMintable.sol)

**↗ Extends: [ERC721](ERC721.md), [ERC721Metadata](ERC721Metadata.md), [MinterRole](MinterRole.md)**
**↘ Derived Contracts: [ERC721FullMock](ERC721FullMock.md), [ERC721MintableBurnableImpl](ERC721MintableBurnableImpl.md)**
...
- [mintWithTokenURI(address to, uint256 tokenId, string tokenURI)](#mintwithtokenuri)
