...
View Source: [contracts/ownership/Ownable.sol](../contracts/ownership/Ownable.sol)

**↘ Derived Contracts: [OwnableMock](OwnableMock.md), [TokenVesting](TokenVesting.md)**
...
```js
function renounceOwnership() public undefined onlyOwner 
```
...
```js
function transferOwnership(address newOwner) public undefined onlyOwner 
```
...
```js
function _transferOwnership(address newOwner) internal undefined
```
