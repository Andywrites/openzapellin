...
View Source: [contracts/drafts/Counter.sol](../contracts/drafts/Counter.sol)

**Counter**

Does not allow an Id of 0, which is popularly used to signify a null state in solidity.
...
- [next(struct Counter.Counter index)](#next)
