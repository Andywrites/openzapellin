...
View Source: [contracts/crowdsale/distribution/FinalizableCrowdsale.sol](../contracts/crowdsale/distribution/FinalizableCrowdsale.sol)

**↗ Extends: [TimedCrowdsale](TimedCrowdsale.md)**
**↘ Derived Contracts: [FinalizableCrowdsaleImpl](FinalizableCrowdsaleImpl.md), [RefundableCrowdsale](RefundableCrowdsale.md)**
