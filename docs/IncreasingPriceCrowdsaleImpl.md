...
View Source: [contracts/mocks/IncreasingPriceCrowdsaleImpl.sol](../contracts/mocks/IncreasingPriceCrowdsaleImpl.sol)

**↗ Extends: [IncreasingPriceCrowdsale](IncreasingPriceCrowdsale.md)**
...
```js
constructor(uint256 initialRate, address wallet, IERC20 token) public
```
