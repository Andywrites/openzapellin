...
View Source: [contracts/token/ERC721/IERC721Receiver.sol](../contracts/token/ERC721/IERC721Receiver.sol)

**↘ Derived Contracts: [ERC721Holder](ERC721Holder.md), [ERC721ReceiverMock](ERC721ReceiverMock.md)**
...
⤿ Overridden Implementation(s): [ERC721Holder.onERC721Received](ERC721Holder.md#onerc721received),[ERC721ReceiverMock.onERC721Received](ERC721ReceiverMock.md#onerc721received)

Handle the receipt of an NFT

```js
function onERC721Received(address operator, address from, uint256 tokenId, bytes data) public undefined
returns(bytes4)
```
