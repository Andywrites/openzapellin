# PullPayment (PullPayment.sol)

View Source: [contracts/payment/PullPayment.sol](../contracts/payment/PullPayment.sol)

**↘ Derived Contracts: [PullPaymentMock](PullPaymentMock.md)**
...
- [withdrawPayments(address payee)](#withdrawpayments)
...
| ------------- |------------- | -----|
| payee | address | Whose balance will be withdrawn. | 
