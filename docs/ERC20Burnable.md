...
View Source: [contracts/token/ERC20/ERC20Burnable.sol](../contracts/token/ERC20/ERC20Burnable.sol)

**↗ Extends: [ERC20](ERC20.md)**
**↘ Derived Contracts: [ERC20BurnableMock](ERC20BurnableMock.md)**
...
```js
function burn(uint256 value) public undefined
```
...
```js
function burnFrom(address from, uint256 value) public undefined
```
