...
View Source: [contracts/mocks/MinterRoleMock.sol](../contracts/mocks/MinterRoleMock.sol)

**↗ Extends: [MinterRole](MinterRole.md)**
**↘ Derived Contracts: [ERC20MintableMock](ERC20MintableMock.md)**

**MinterRoleMock**

## Functions

- [removeMinter(address account)](#removeminter)
- [onlyMinterMock()](#onlymintermock)
...
⤾ overrides [MinterRole._removeMinter](MinterRole.md#_removeminter)
