...
Moreover, it includes approve all functionality using operator terminology (ERC721Full.sol)

View Source: [contracts/token/ERC721/ERC721Full.sol](../contracts/token/ERC721/ERC721Full.sol)
