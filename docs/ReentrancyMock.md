...
View Source: [contracts/mocks/ReentrancyMock.sol](../contracts/mocks/ReentrancyMock.sol)
...
- [callback()](#callback)
- [countLocalRecursive(uint256 n)](#countlocalrecursive)
- [countThisRecursive(uint256 n)](#countthisrecursive)
- [countAndCall(ReentrancyAttack attacker)](#countandcall)
- [count()](#count)
