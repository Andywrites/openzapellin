# ConditionalEscrow (ConditionalEscrow.sol)

View Source: [contracts/payment/escrow/ConditionalEscrow.sol](../contracts/payment/escrow/ConditionalEscrow.sol)

**↗ Extends: [Escrow](Escrow.md)**
**↘ Derived Contracts: [ConditionalEscrowMock](ConditionalEscrowMock.md), [RefundEscrow](RefundEscrow.md)**
...
- [withdrawalAllowed(address payee)](#withdrawalallowed)
- [withdraw(address payee)](#withdraw)

### withdrawalAllowed

⤿ Overridden Implementation(s): [ConditionalEscrowMock.withdrawalAllowed](ConditionalEscrowMock.md#withdrawalallowed),[RefundEscrow.withdrawalAllowed](RefundEscrow.md#withdrawalallowed)
...
⤾ overrides [Escrow.withdraw](Escrow.md#withdraw)

```js
function withdraw(address payee) public undefined
```
