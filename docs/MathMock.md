...
View Source: [contracts/mocks/MathMock.sol](../contracts/mocks/MathMock.sol)
...
```js
function max(uint256 a, uint256 b) public
returns(uint256)
```
...
```js
function average(uint256 a, uint256 b) public
returns(uint256)
```
